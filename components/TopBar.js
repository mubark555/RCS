...
const TITLES = {
  ...
  "/reports": { t: "التقارير", s: "ملخّص شامل لأداء المشاريع والمستهدفات والمالية" },
  "/finance": { t: "المالية", s: "فواتير فيوليت إلى سيم برايم والمدفوعات والمقابل المالي" },
  "/meetings": { t: "الاجتماعات", s: "جدولة ومتابعة اجتماعات الفريق والعملاء" },
  "/activity": { t: "سجل الأنشطة", s: "توثيق آخر الإجراءات داخل النظام" },
