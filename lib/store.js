...
export const SEED_PROJECTS = [
  { name: "Seem prime", description: "مشاريع سيم برايم الاستثمارية والبنية الرقمية", manager: "لجين", client: "عميل سيم برايم", color: "#e05a50", status: "نشط" },
  { name: "Homera", description: "منصة هوميرا العقارية الرقمية + التطبيق", manager: "لجين", client: "عميل هوميرا", color: "#3f8e7f", status: "نشط" },
  { name: "ZL.Tours", description: "منصة ZL للسياحة والحجوزات الإلكترونية", manager: "وجد", client: "عميل ZL.Tours", color: "#2563eb", status: "نشط" },
  { name: "Jaz chocolate", description: "الهوية والتغليف والتصاميم لعلامة جاز", manager: "وجد", client: "عميل جاز", color: "#d97706", status: "نشط" },
  { name: "eat plus", description: "منصة eat plus", manager: "أمل", client: "عميل إيت بلس", color: "#7c3aed", status: "نشط" },
];
